          ...
          <div style={{ flex: "0 0 65%", borderRadius: "16px", overflow: "hidden", marginRight: "16px", border: "1px solid rgba(255,255,255,0.08)" }}>
            {loading ? (
                ...
                {branches.map((branch) => (
                  ...
                  >
                    <div onClick={() => handleBranchClick(branch)}>
                      <BranchPin status={branch.status} />
                    </div>
                  </OverlayView>
                ))}

                {/* Info overlay for clicked branch */}
                {infoOverlay && (
                  <OverlayView
                  ...
                  >
                    <div style={{
                      ...
                      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "start", marginBottom: "8px" }}>
                        ...
                        <button
                          onClick={(e) => { e.stopPropagation(); setInfoOverlay(null); }}
              ...
              <div style={{
                ...
                <p style={{ color: "#64748b", fontSize: "13px" }}>Add NEXT_PUBLIC_GOOGLE_MAPS_API_KEY to .env.local</p>
              </div>
            )}
          </div>
